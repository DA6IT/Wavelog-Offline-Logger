...
Die Bilder zeigen Version 0.18.0 mit automatisch erzeugten, isolierten Demo-Daten. Der Aufnahmeprozess greift weder auf echte Logger-Profile noch auf Funkgerät, Netzwerk, API-Tokens oder persönliche ADI-Dateien zu.
