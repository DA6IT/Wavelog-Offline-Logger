...
Version 0.18.2 remains unsigned while the project prepares its SignPath application. Signing integration must only be enabled after real SignPath organization/project/policy identifiers are available.
